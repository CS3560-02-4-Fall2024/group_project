...
function Navbar() {
    ...
    return (<div className="h-[12vh] w-[100vw] bg-g float-left ml-0 pl-0 flex justify-center">
        ...
        <button onClick={Logout} className="w-36 h-1/2 bg-dg hover:bg-[#587354] self-center justify-self-end ml-auto mr-3.5 rounded-md text-white font-mono text-2xl">Logout</button>
    </div>)
}
